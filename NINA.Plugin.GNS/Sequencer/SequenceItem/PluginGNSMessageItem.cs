...
namespace NINA.Plugin.GNS.Sequencer.SequenceItem {
    ...
    /// </summary>
    [ExportMetadata("Name", "GNS Message")]
    [ExportMetadata("Description", "This GNS Item will send a message with the given timeout to the GNS system.")]
    ...
    public class PluginGNSMessageItem : NINA.Sequencer.SequenceItem.SequenceItem {
        ...
        public override Task Execute(IProgress<ApplicationStatus> progress, CancellationToken token) {
            ...
            this.GNSUtil.sendMessage(Timeout >= -2 ? Timeout : 300, "Message: " + Text);
        ...
        public override object Clone() {
            return new PluginGNSMessageItem() {
                Icon = Icon,
                Name = Name,
                Text = Text,
                Timeout = Timeout,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(PluginGNSMessageItem)}";
        }
    }
}