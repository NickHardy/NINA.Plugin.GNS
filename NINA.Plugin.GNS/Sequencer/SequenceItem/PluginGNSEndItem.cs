...
namespace NINA.Plugin.GNS.Sequencer.SequenceItem {
    ...
    /// </summary>
    [ExportMetadata("Name", "GNS End session")]
    ...
    public class PluginGNSEndItem : NINA.Sequencer.SequenceItem.SequenceItem {
        ...
        public override Task Execute(IProgress<ApplicationStatus> progress, CancellationToken token) {
            ...
            this.GNSUtil.sendMessage(-2, "Session finished.");
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(PluginGNSEndItem)}";
        }
    }
}