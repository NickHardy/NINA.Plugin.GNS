...
namespace NINA.Plugin.GNS.Sequencer.SequenceItem {
    ...
    /// </summary>
    [ExportMetadata("Name", "GNS Alert session")]
    [ExportMetadata("Description", "This GNS Item will alert the GNS system.")]
    [ExportMetadata("Icon", "Plugin_GNS_SVG")]
    [ExportMetadata("Category", "GNS")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class PluginGNSAlertItem : NINA.Sequencer.SequenceItem.SequenceItem {
        ...
        public override Task Execute(IProgress<ApplicationStatus> progress, CancellationToken token) {
            ...
            this.GNSUtil.sendMessage(0, "Session Alert: " + Text);
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(PluginGNSAlertItem)}";
        }
    }
}